...
mod test {
    ...
    fn serialize_deserialize_test() {
        assert_eq!(
            r#"{"uuid":"00000000-0000-0000-0000-000000000011","name":"Odysseus","gender":"masculine","age":"middle-aged","age_years":null,"size":{"type":"Medium","height":72,"weight":180},"species":"human","ethnicity":"human","location_uuid":null}"#,
            serde_json::to_string(&test::npc::odysseus()).unwrap()
        );

        let value: Npc = serde_json::from_str(r#"{"uuid":"00000000-0000-0000-0000-000000000011","name":"Odysseus","gender":"masculine","age":"middle-aged","age_years":null,"size":{"type":"Medium","height":72,"weight":180},"species":"human","ethnicity":"human","location_uuid":null}"#).unwrap();
