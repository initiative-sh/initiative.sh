    ...
    fn autocomplete_test() {
        assert_autocomplete(
            &[
                ...
                ("Deck Of Illusions", "SRD magic item"),
                ("Deck Of Many Things", "SRD magic item"),
                ("Defender", "SRD magic item"),
                ("Delayed Blast Fireball", "SRD spell"),
                ("Demiplane", "SRD spell"),
                ("Demon Armor", "SRD magic item"),
                ("Detect Evil And Good", "SRD spell"),
                ("Detect Magic", "SRD spell"),
                ("Detect Poison And Disease", "SRD spell"),
                ("Detect Thoughts", "SRD spell"),
                ("Dice Set", "SRD item"),
                ("Dimension Door", "SRD spell"),
                ("Dimensional Shackles", "SRD magic item"),
                ("Diplomat's Pack", "SRD item"),
                ("Disguise Kit", "SRD item"),
                ("Disguise Self", "SRD spell"),
                ("Disintegrate", "SRD spell"),
                ("Dispel Evil And Good", "SRD spell"),
                ("Dispel Magic", "SRD spell"),
                ("Divination", "SRD spell"),
                ("Divine Favor", "SRD spell"),
                ("Divine Word", "SRD spell"),
                ("Dominate Beast", "SRD spell"),
                ("Dominate Monster", "SRD spell"),
                ("Dominate Person", "SRD spell"),
                ("Donkey", "SRD item"),
                ("Draft Horse", "SRD item"),
                ("Dragon Scale Mail", "SRD magic item"),
                ("Dragon Slayer", "SRD magic item"),
                ("Dream", "SRD spell"),
                ("Druidcraft", "SRD spell"),
                ("Drum", "SRD item"),
                ("Dulcimer", "SRD item"),
                ("Dungeoneer's Pack", "SRD item"),
                ("Dust Of Disappearance", "SRD magic item"),
                ("Dust Of Dryness", "SRD magic item"),
                ("Dust Of Sneezing And Choking", "SRD magic item"),
                ("Dwarven Plate", "SRD magic item"),
                ("Dwarven Thrower", "SRD magic item"),
